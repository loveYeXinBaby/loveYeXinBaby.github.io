    ...
    (function(module, exports, __webpack_require__) {
        ...
        var config = function() {
            ...
            return {
                ...
                dialogue: [{ type: 6, name: '男子', txt: '突然发现我们原来也认识了有一段时间了。' }, { type: 6, name: '男子', txt: '今年五月份就认识了！' }, { type: 2, name: '女子', txt: '嘻嘻，是啊。' }, { type: 6, name: '男子', txt: '快七夕节了，我们去放烟花吧！' }, { type: 2, name: '女子', txt: '天还这么亮，现在放烟花也不好看。' }, { type: 2, name: '女子', txt: '再说你那有烟花吗？' }, { type: 6, name: '男子', txt: '我当然有烟花啦。' }, { type: 6, name: '男子', txt: '你那有打火机吗？' }, { type: 2, name: '女子', txt: '没有呀～' }, { type: 6, name: '男子', txt: '那你是怎么点燃我的心的？' }, { type: 2, name: '女子', txt: '。。。' }, { type: 2, name: '女子', txt: '可是我的心还没有被你点燃呀。' }, { type: 6, name: '男子', txt: '别慌，我去买个打火机先。' }, { type: 2, name: '女子', txt: '打火机可点不燃我的心。' }, { type: 6, name: '男子', txt: '天快黑了，我要为你点燃整片天空，点燃你。' }],
                // 阶段二
                sunset: 8000,
                ...
                fireWords: '希望|宝宝|做自己女王|不卑不亢|我愿|和宝宝|携手|每一天',
                // hue:210 lightness 0

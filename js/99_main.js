 ...
 */
 	...
 	page_touch_start: function(e){
		...
		let touchDeltaY = car2.beforeLocation - window.event.touches[0].pageY
		console.log("car2._touchStartValY", car2.beforeLocation,window.event.touches[0].pageY);
		
		if (window.event.touches[0].pageY) {
		 
		car2.beforeLocation = window.event.touches[0].pageY;
		}
		
		if(car2._pageNow == car2._pageNum - 1 && touchDeltaY <0) return
 	...
 	page_touch_move : function(e){
		// console.log("car2._pageNex",car2._pageNext,car2._pageNow)
		
		// if(window.event.touches[0].pageY!='undefined') car2._touchDeltaY = window.event.touches[0].pageY - car2._touchStartValY;
			
		// 	console.log("car2._pageNex",car2._pageNext,car2._pageNow,car2._touchDeltaY)
			
		// 	//禁止最后一张向下滑动
		// 	if( car2._touchDeltaY<0 && (car2._pageNext ==4  && car2._pageNow==3 || car2._pageNow ==4)) {
